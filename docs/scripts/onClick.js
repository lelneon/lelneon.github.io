...
function playPortal() {
  const sounds = {
    ...
    turret1: new Audio('sounds/turret/turret1.wav'),
    turret2: new Audio('sounds/turret/turret2.wav'),
    turret3: new Audio('sounds/turret/turret3.wav'),
    turret4: new Audio('sounds/turret/turret4.wav'),
    turret5: new Audio('sounds/turret/turret5.wav'),
    turret6: new Audio('sounds/turret/turret6.wav'),
    turret7: new Audio('sounds/turret/turret7.wav'),
    turret8: new Audio('sounds/turret/turret8.wav'),
    turret9: new Audio('sounds/turret/turret9.wav'),
    turret10: new Audio('sounds/turret/turret10.wav'),
    turret11: new Audio('sounds/turret/turret11.wav'),
    turret12: new Audio('sounds/turret/turret12.wav'),
    turret13: new Audio('sounds/turret/turret13.wav'),
    turret14: new Audio('sounds/turret/turret14.wav'),
    turret15: new Audio('sounds/turret/turret15.wav'),
    turret16: new Audio('sounds/turret/turret16.wav'),
    turret17: new Audio('sounds/turret/turret17.wav'),
    turret18: new Audio('sounds/turret/turret18.wav'),
    turret19: new Audio('sounds/turret/turret19.wav'),
    turret20: new Audio('sounds/turret/turret20.wav'),
    turret21: new Audio('sounds/turret/turret21.wav'),
    turret22: new Audio('sounds/turret/turret22.wav'),
    turret23: new Audio('sounds/turret/turret23.wav'),
    turret24: new Audio('sounds/turret/turret24.wav'),
    turret25: new Audio('sounds/turret/turret25.wav'),
    turret26: new Audio('sounds/turret/turret26.wav'),
    turret27: new Audio('sounds/turret/turret27.wav'),
    turret28: new Audio('sounds/turret/turret28.wav'),
    turret29: new Audio('sounds/turret/turret29.wav'),
    turret30: new Audio('sounds/turret/turret30.wav'),
  };
